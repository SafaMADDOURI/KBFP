...
# Variables
FILES_DIR="/store/EQUIPES/SSFA/MEMBERS/safa.maddouri/KBFP/protocole_KBFP/RibosomeProfilingMarc"
SCRIPTS_DIR="/store/EQUIPES/SSFA/MEMBERS/safa.maddouri/KBFP/protocole_KBFP/SCRIPTS"

# Exécution des scripts de post-traitement
python3 "$SCRIPTS_DIR/plotPhase.py" "$FILES_DIR/KmersFromContigsQuerySumPhaseSeqTranslatedPvalue" "$FILES_DIR/plots"
